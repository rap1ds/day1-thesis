...
Job satisfaction is one of the key elements in today's work life. From a company point-of-view an employee who enjoys the work is more effective that an employee who dislikes the work. Companies are also competing with each other of the best employees and one key factor to draw good employee candidates is to have a working environment where employees enjoy to work. Extreme employee benefits such as free lunches, sodas or even beer have been offered in order to hire skilled work force \citep{huffington}.

Job satisfaction plays also a great role in coping in the work environment. In Finland, there is a pressure to raise the age of retirement. High job satisfaction has been identified to be one of the key elements to help employees to cope longer in work life \citep{ek}.
...
It's common belief that caffeine has a positive effect on work performance. Another common belief is that due to the same reason coders, or in general people in IT-sectory drink a lot of soft drinks with caffeine. However, studies has shown that the perceived positive effects are almost wholly attributable to reversal of adverse withdrawal effects \citep{james2005}.
...
To answer to the main research question, there are three subquestions: Does free soda have a positive effect on job satisfaction? Does it increase the work performance? How much would free soda cost to the company? It can be argued that offering free soda is worthwhile if the increase in job satisfaction and performance overcomes the costs.
...
The research method to answer to the research question is to have formal structured interviews. The interviews was selected as a research method because with the interviews both the consumption of soda and the perceived effect can be answered. The interviews was decided to be formal to be able to draw some statistical analysis on the results.
